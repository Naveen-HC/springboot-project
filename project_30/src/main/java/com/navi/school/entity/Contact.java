...
@NamedQueries({
        @NamedQuery(name = "Contact.findOpenMsg", query = "select c from Contact c where status = ?1"),
        @NamedQuery(name = "Contact.updateStatus", query = "update Contact c set status = ?1 where contactId = ?2")
})
